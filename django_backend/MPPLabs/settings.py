"""
Django settings for MPPLabs project.
...
SECRET_KEY = 'django-insecure-k$sq5cnkg+$!!dsudxj*l+lf$av2$6ytec!5u%tgjs8lptkob!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['34.154.19.229', '127.0.0.1']
...
WSGI_APPLICATION = 'MPPLabs.wsgi.application'
